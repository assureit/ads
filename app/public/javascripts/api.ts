...
module DCaseAPI {
	...
	export var commit = function(tree, msg: string, commitId: number, summary: any) {
	...
	export var getProjectList = function() {
	...
	export var getProject = function(projectId: number) {
