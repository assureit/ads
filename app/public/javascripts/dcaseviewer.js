...
var DCaseViewer = (function () {
    function DCaseViewer(root, dcase, editable) {
        ...
        var $svgroot = $(document.createElementNS(SVG_NS, "svg")).attr({ width: "100%", height: "100%" }).appendTo(this.$root);
...
var DNodeView = (function () {
        ...
        if (parentView != null) {
            if (node.isContext) {
                ...
                if (this.node.type == "Subject")
                    parentView.subject = this; else if (this.node.type == "Rebuttal")
                    parentView.rebuttal = this; else
    ...
    DNodeView.prototype.remove = function (parentView) {
        ...
        if (this.node.isContext) {
            if (this.node.type == "Subject")
                parentView.subject = null; else if (this.node.type == "Rebuttal")
                parentView.rebuttal = null; else
